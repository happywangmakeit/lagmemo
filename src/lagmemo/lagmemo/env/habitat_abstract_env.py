...
import lagmemo
import lagmemo.core.abstract_env

ActType = TypeVar("ActType")


class HabitatEnv(lagmemo.core.abstract_env.Env):
    """
    Base environment that lets a lagmemo agent interact with the Habitat
    simulator.

    Subclasses need to implement translation from Habitat observations into
    lagmemo observations and from lagmemo actions back into Habitat
    actions.
    """
    ...
    def apply_action(
        self,
        action: lagmemo.core.interfaces.Action,
        info: Optional[Dict[str, Any]] = None,
        prev_obs: Optional[lagmemo.core.interfaces.Observations] = None,
    ):
        if info is not None:
    ...
    def get_observation(self) -> lagmemo.core.interfaces.Observations:
        return self._last_obs
    ...
    def _preprocess_obs(
        ...
        """Translate Habitat observations into lagmemo observations."""
        pass
    ...
    def _preprocess_action(
        ...
        """Translate a lagmemo action into a Habitat action."""
        pass
