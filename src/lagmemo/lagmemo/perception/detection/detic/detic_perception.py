...
from lagmemo.core.abstract_perception import PerceptionModule
from lagmemo.core.interfaces import Observations
from lagmemo.perception.detection.utils import filter_depth, overlay_masks
...
from lagmemo.perception.detection.detic.Detic.detic.config import (  # noqa: E402
    add_detic_config,
)
from lagmemo.perception.detection.detic.Detic.detic.modeling.text.text_encoder import (  # noqa: E402
    build_text_encoder,
)
from lagmemo.perception.detection.detic.Detic.detic.modeling.utils import (  # noqa: E402
    reset_cls_test,
)
